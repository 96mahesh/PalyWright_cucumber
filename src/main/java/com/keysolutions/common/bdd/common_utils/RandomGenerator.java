...
public final class RandomGenerator {
	...
	public static String randomEmailAddress(Integer length) {
		String email = randomAlphanumeric(length) + "@yomail.com";
		return email.toLowerCase();
	}

	/**
	 * Generates random gender in short text form "M" , "F" , "U" M = Male , F =
	 * Female , U = Unspecified
	 */
	...
	/**
	 * Generates random gender in full text form Male , Female , Unspecified
	 */
